...
def parse_tags(df):
    ...
    category_columns = df.filter(regex='^Project categories \(please select at most one per row\)').columns
...
def main():
    ...
    for _, row in post_df.iterrows():
        ...
        yaml_content = create_yaml(row['Project Title'], ['admin'], row['tags'], row['Project Author Twitter handle'])
